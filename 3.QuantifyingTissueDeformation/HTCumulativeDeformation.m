...
baseFolder = '\\tierra.cnic.es\SC\LAB_MT\RESULTADOS\Morena\Mapping - Copy';
...
Folder = '\\tierra.cnic.es\SC\LAB_MT\RESULTADOS\Morena\Mapping - Copy\';
...
FolderPre = '\\tierra.cnic.es\SC\LAB_MT\RESULTADOS\Morena\Mapping - Copy\Cluster';
SubFolder = '\Deformation\DynamicAtlas\';
...
[node,face] = read_ply(['\\tierra.cnic.es\SC\LAB_MT\RESULTADOS\Morena\Mapping\Atlas\remesh' num2str(group(e)) '.ply']);
