...
embryoFile = '\Code_Data\1. EstimatingIndividualLiveImageMotion\1.6Error2\Cells\Reslice of thalf.tif';
output = '\Code_Data\1. EstimatingIndividualLiveImageMotion\1.6Error2\Cells\GT'
...
Im = loadtiff('\Code_Data\1. EstimatingIndividualLiveImageMotion\1.6Error2\Cells\Reslice of tend.tif');
load('\Code_Data\1. EstimatingIndividualLiveImageMotion\Embryo2\disp.mat');
output = '\Code_Data\1. EstimatingIndividualLiveImageMotion\1.6Error2\Cells\Test';
...
cellMid = loadtiff('\Code_Data\1. EstimatingIndividualLiveImageMotion\1.6Error2\Cells\Reslice of t1.tif');
[V, F] = read_ply('\Code_Data\1. EstimatingIndividualLiveImageMotion\Embryo2\Shape\CC1.ply');
...
for i = 1:length(unique(Im)) - 1
    ...
    [V_test, F_test] = read_ply(['\Code_Data\1. EstimatingIndividualLiveImageMotion\1.6Error2\Cells\Test\primo0000' num2str(i) '.ply']);
    line_test = fitLine3d(V_test);
    
    % Load corresponding cell mesh from the Ground Truth (_primo)
    [V_gt, F_gt] = read_ply(['\Code_Data\1. EstimatingIndividualLiveImageMotion\1.6Error2\Cells\GT\primo' num2str(i) '.ply']);
    ...
    [V_test, F_test] = read_ply(['\Code_Data\1. EstimatingIndividualLiveImageMotion\1.6Error2\Cells\Test\ultimo0000' num2str(i) '.ply']);
    line_test = fitLine3d(V_test);
    
    % Load corresponding cell mesh from the Ground Truth (_ultimo)
    [V_gt, F_gt] = read_ply(['\Code_Data\1. EstimatingIndividualLiveImageMotion\1.6Error2\Cells\GT\ultimo' num2str(i) '.ply']);
    line_gt = fitLine3d(V_gt);
